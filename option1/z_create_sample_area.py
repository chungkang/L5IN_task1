...
with open('geojson_result\\17102022\\4OG_original_EPSG32632.geojson') as f:
...
for door_line in using_door_lines:
    # try:
        ...
        create_geojson.write_geojson('geojson_result\\17102022\\filtered_walls.geojson', filtered_walls_geojson)
        ...
        result_geojson["features"].append(line1_feature)
        ...
        line1_90_feature = {
            ...
            "geometry":geometry.mapping(rotated_line1_90)
        }
        result_geojson["features"].append(line1_90_feature)
...
create_geojson.write_geojson('geojson_result\\17102022\\result.geojson', result_geojson)
create_geojson.write_geojson('geojson_result\\17102022\\room_index.geojson', room_index_geojson)