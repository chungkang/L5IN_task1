...
create_geojson.write_geojson('option1_walls_2nd\\\\option1.geojson', origin_geojson)

# read created geojson / reprojection to EPSG:32632 / write reprojected geojson
loaded_geojson = geopandas.read_file('option1_walls_2nd\\\\option1.geojson')
loaded_geojson = loaded_geojson.to_crs("EPSG:32632")
loaded_geojson.to_file("option1_walls_2nd\\\\option1_EPSG32632.geojson", driver='GeoJSON')
...
with open('option1_walls_2nd\\\\option1_EPSG32632.geojson') as f:
...
create_geojson.write_geojson('option1_walls_2nd\\\\option1_door_polygon.geojson', door_polygon_geojson)
...
for door_index in range(len(door_polygon_geojson["features"])):
    ...
    # for door_point_index in [0,2]:
        try:
            ...
            create_geojson.write_geojson('option1_walls_2nd\\\\filtered_walls.geojson', filtered_walls_geojson)
...
create_geojson.write_geojson('option1_walls_2nd\\\\rooms.geojson', room_geojson)
...
# with open('option1_walls_2nd\\\\option1_outer_wall.geojson', 'wt', encoding='utf8') as fp:
